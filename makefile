...
DERIVEDCLASSOBJS=FIFOcache.o LIFOcache.o MRUcache.o RRcache.o LRUcache.o LFUcache.o OPTcache.o TLDRcache.o traversals.o ListGraph.o MatrixGraph.o CompMatrixGraph.o
...
TLDRcache.o: TLDRcache.h TLDRcache.cpp
	$(CC) $(CFLAGS) -c TLDRcache.cpp TLDRcache.h
